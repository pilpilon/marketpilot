  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    if (error) {
      ...
      if (data.user) {
        ...
        if (profile?.locale) {
          document.cookie = `locale=${profile.locale}; path=/; max-age=31536000`;
        }
      }
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="font-heading text-3xl font-extrabold tracking-tight">{t("welcomeBack")}</h1>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-3 text-muted-foreground font-medium">{t("orContinueWithEmail")}</span>
            </div>
          </div>
